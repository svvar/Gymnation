...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0010_alter_gymuser_club_alter_gymuser_photo_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='gymuser',
            name='plan',
            field=models.CharField(blank=True, choices=[('STARTER', 'STARTER'), ('STANDARD', 'STANDARD'), ('PREMIUM', 'PREMIUM'), ('PREMIUM SPA', 'PREMIUM SPA')], max_length=20, null=True),
        ),
    ]
